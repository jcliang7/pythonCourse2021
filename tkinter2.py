...
Entry(root, width=50).grid(row=0, column=1, sticky=W,columnspan=2)
Button(root, text="ubmit").grid(row=0, column=3)
...
Label(root, text="Benefits").grid(row=1, column=2, sticky=W)
Checkbutton(root, text="Free Shipping").grid(row=2, column = 2, sticky = W)
Checkbutton(root, text="Bonus Gift").grid(row=3, column=2, sticky=W)
root.mainloop()
